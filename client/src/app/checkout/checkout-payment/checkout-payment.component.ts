...
export class CheckoutPaymentComponent implements AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    ngAfterViewInit() {
      this.stripe = Stripe('pk_test_51H6dV7CCQVaxdBEng5jBicZ6uFfRKXIVGwSRpwzuYzRlXmT8ZPRB5761RCyPkmwVQUtNaLoKYVXHm6Jnl59AT51h00YkjzvBAv');
